...
const App: React.FC = () => {
  ...
  return (
    <div className="h-[100dvh] bg-transparent bg-disco-grid text-zinc-50 selection:bg-pink-500/30 overflow-y-auto overflow-x-hidden relative flex flex-col">
      ...
      >
        ...
        <div className="flex-shrink-0 pb-6 w-full mt-auto flex flex-col items-center gap-6">
            ...
            <a 
              ...
              className="text-pink-400/60 hover:text-pink-300 text-xs font-mono transition-colors pb-2 tracking-widest uppercase"
            >
              Created by the Unicorn Mafia
            </a>
        </div>
      </div>
      ...
      <div className="fixed bottom-4 right-4 z-50">
        <button 
            ...
            className="flex items-center space-x-2 p-2 text-pink-500/60 hover:text-pink-300 transition-colors opacity-60 hover:opacity-100"
            title="Import Artifact"
        >
            <span className="text-xs font-medium uppercase tracking-wider hidden sm:inline">Upload Artifact</span>
